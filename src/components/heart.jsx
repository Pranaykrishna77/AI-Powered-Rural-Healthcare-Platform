...
export const Heart = ({ setResult }) => {
    const [formData, setFormData] = useState({ age: "", cholesterol: "", bp: "" });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:5000/api/heart', { // Fixed API URL
                method: 'POST',
    ...
    return (
        <div className="container mx-auto p-6">
            <h2 className="text-center text-2xl font-bold mb-4">Heart Disease Diagnosis</h2>
            <form onSubmit={handleSubmit} className="max-w-md mx-auto bg-white p-6 shadow-md rounded-lg">
                ...
                <div className="mb-4">
                    <label className="block font-medium">Cholesterol Level:</label>
                    <input
                        type="number"
                        name="cholesterol"
